...
public static void customerOrder(Scanner sc) {
    ...
    int totalBill = calculateBill(cementPrice, cementQuantity,steelPrice, steelQuantity);
...
public static int calculateBill(int cementPrice, int cementQty, int steelPrice, int steelQty) {
